...
mainTl.add(starTl, 0)
gsap.globalTimeline.timeScale(0.8);    //圣诞树开始绘画时小光点动画的绘画速率，数字越大速率越快！


setTimeout( function(){
var element = document.getElementById("header");
element.innerHTML = "祝圣诞快乐，新年充满幸福和成功。";//header文本修改在这里！
...
element.innerHTML = "<br />    圣诞来临，祝新年快乐"+"<br />    愿你时时刻刻幸福顺利!";//p2文本修改在这里！
var element = document.getElementById("p1");
element.innerHTML =" <br />    By_Nino";//p1文本修改在这里！
